    ...
    <div className="py-5">
      <div className="card card-side flex flex-col md:flex-row bg-base-100 shadow-xl p-5 border">
        <figure className="rounded-md bg-gray-200">
          <img className="md:w-[50vh]" src={image} alt="book" />
        </figure>
        <div className="card-body">
          ...
          <div className="flex items-center flex-wrap gap-5">
            {tags.map((tag) => (
              <a
                key={tag.id}
                className=" px-2 rounded-sm hover:underline text-lime-600 font-bold"
              >
                #{tag}
              </a>
            ))}
          ...
          <div className="flex items-center gap-5">
            ...
            <Link to={"/book"}>
              <button className="btn bg-lime-500 text-white font-semibold">
                View Details
              </button>
            </Link>
          </div>
